...
### Safe Mode
By default, this mod implements its own safe mode to prevent making accidental progression in levels while this mod is active. Remember, <cr>**using this mod counts as cheating**</c>! You can also disable this in the mod's settings while you're not actively using any horrible options.
